...
$package->dependencies['required']->package['pear2.php.net/PEAR2_Autoload']->min('0.2.4');
...
$package->dependencies['required']->package['pear2.php.net/PEAR2_Console_CommandLine']->min('0.2.0');

$compatible->dependencies['required']->php = '5.3.1RC1';
$compatible->dependencies['required']->package['pear2.php.net/PEAR2_Autoload']->min('0.2.4');
...
$compatible->dependencies['required']->package['pear2.php.net/PEAR2_Console_CommandLine']->min('0.2.0');
