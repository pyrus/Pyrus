--TEST--
\Pyrus\Task\Postinstallscript::validateXml() failures 5
--FILE--
<?php
...
$xmltest(array(), array('role' => 'php', 'name' => 'glooby'), 'task <postinstallscript> in file filename is invalid because of "Post-install script "glooby" class "poo" must be named "glooby_postinstall""', '\Pyrus\Task\Exception\Invalidtask');
