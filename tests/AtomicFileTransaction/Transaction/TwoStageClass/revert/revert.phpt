...
$test->assertFileNotExists($backupPath, $backupPath . ' after revert');
$test->assertFileNotExists($backupPath . '/foo', $backupPath . '/foo after revert');
$test->assertFileNotExists($backupPath . '/newfile', $backupPath . '/newfile after revert');
$test->assertFileNotExists($backupPath . '/another', $backupPath . '/another after revert');
$test->assertFileNotExists($backupPath . '/sub/deep/deep/thing', $backupPath . '/sub/deep/deep/thing after revert');
$test->assertFileNotExists($backupPath . '/anothernew/dir', $backupPath . '/another/dir after revert');
$test->assertFileNotExists($backupPath . '/anothernew/dir/file', $backupPath . '/another/dir/file after revert');

$test->assertFileExists($path, $path . ' after revert');
$test->assertFileExists($path . '/foo', $path . '/foo after revert');
$test->assertFileExists($path . '/another', $path . '/another after revert');
$test->assertFileExists($path . '/sub/deep/deep/thing', $path . '/sub/deep/deep/thing after revert');
$test->assertFileExists($path . '/anothernew/dir', $path . '/another/dir after revert');
$test->assertFileExists($path . '/anothernew/dir/file', $path . '/another/dir/file after revert');

$test->assertFileNotExists($journalPath, $journalPath . ' after revert');
$test->assertFileNotExists($journalPath . '/foo', $journalPath . '/foo after revert');
$test->assertFileNotExists($journalPath . '/newfile', $journalPath . '/newfile after revert');
$test->assertFileNotExists($journalPath . '/another', $journalPath . '/another after revert');
$test->assertFileNotExists($journalPath . '/sub/deep/deep/thing', $journalPath . '/sub/deep/deep/thing after revert');
$test->assertFileNotExists($journalPath . '/anothernew/dir', $journalPath . '/another/dir after revert');
$test->assertFileNotExists($journalPath . '/anothernew/dir/file', $journalPath . '/another/dir/file after revert');
