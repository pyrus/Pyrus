...
} catch (\PEAR2\Pyrus\PackageFile\v2\Dependencies\Exception $e) {
...
try {
    ...
    $test->assertEquals('Can only set arch to \PEAR2\Pyrus\PackageFile\v2\Dependencies\Dep object',
...
try {
    ...
    $test->assertEquals('Can only set os to \PEAR2\Pyrus\PackageFile\v2\Dependencies\Dep object',
...
try {
    ...
    $test->assertEquals('Can only set package to \PEAR2\Pyrus\PackageFile\v2\Dependencies\Package object',
...
try {
    ...
    $test->assertEquals('Can only set subpackage to \PEAR2\Pyrus\PackageFile\v2\Dependencies\Package object',
...
try {
    ...
    $test->assertEquals('Can only set extension to \PEAR2\Pyrus\PackageFile\v2\Dependencies\Package object',
