...
} catch (\Pyrus\PackageFile\v2\UsesRoleTask\Exception $e) {
...
try {
    ...
    $test->assertEquals('Can only set usestask to a \Pyrus\PackageFile\v2\UsesRoleTask object', $e->getMessage(), '[foo] = 1');
}
