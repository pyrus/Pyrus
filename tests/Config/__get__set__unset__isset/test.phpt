--TEST--
\Pyrus\Config::__get() and friends
--FILE--
<?php
...
$test->assertEquals('Pyrus\Registry', get_class($a->registry), 'registry');
$test->assertEquals('Pyrus\ChannelRegistry', get_class($a->channelregistry), 'channelregistry');
