...
$test->assertEquals(true, file_exists(TESTDIR . '/cfg/P1/pear2.php.net/test.txt'), 'cfg was installed');
...
$test->assertEquals('first try', file_get_contents(TESTDIR . '/cfg/P1/pear2.php.net/test.txt'), 'cfg contents normal');
$test->assertEquals(false, file_exists(TESTDIR . '/cfg/P1/pear2.php.net/test.txt.new-1.0.1'),
...
$test->assertEquals('1.0.2', \PEAR2\Pyrus\Config::current()->registry->info('P1', 'pear2.php.net', 'version'),
                    'upgraded 2');
$test->assertEquals('second try', file_get_contents(TESTDIR . '/cfg/P1/pear2.php.net/test.txt'), 'cfg contents normal');
$test->assertEquals(false, file_exists(TESTDIR . '/cfg/P1/pear2.php.net/test.txt.new-1.0.2'),
                    'cfg should not be detected as changed 1.0.2');

$pf->version['release'] = '1.0.3';
file_put_contents(TESTDIR . '/package.xml', $pf);
$package = new \PEAR2\Pyrus\Package(TESTDIR . '/package.xml');
file_put_contents(TESTDIR . '/cfg/P1/pear2.php.net/test.txt', 'I modified this');
...
$test->assertEquals('1.0.3', \PEAR2\Pyrus\Config::current()->registry->info('P1', 'pear2.php.net', 'version'),
                    'upgraded 3');
$test->assertEquals('I modified this', file_get_contents(TESTDIR . '/cfg/P1/pear2.php.net/test.txt'), 'cfg contents normal');
$test->assertEquals(true, file_exists(TESTDIR . '/cfg/P1/pear2.php.net/test.txt.new-1.0.3'),
                    'cfg should be detected as changed 1.0.3');
$test->assertEquals('second try', file_get_contents(TESTDIR . '/cfg/P1/pear2.php.net/test.txt.new-1.0.3'),
