...
$test->assertEquals(array('skipping installed package check of "channel://pear2.php.net/foo", version "1.2.3" will be downloaded and installed'), \Pyrus\Logger::$log[3], 'log');
?>
===DONE===
--CLEAN--
<?php
