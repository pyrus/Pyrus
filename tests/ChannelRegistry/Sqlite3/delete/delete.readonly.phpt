--TEST--
\Pyrus\ChannelRegistry\Sqlite3::delete() readonly test
--FILE--
<?php
require dirname(__DIR__) . '/../setup.php.inc';
// construct the registries first
$creg = new \Pyrus\ChannelRegistry\Sqlite3(TESTDIR, false);
$creg = new \Pyrus\ChannelRegistry\Sqlite3(TESTDIR, true);
