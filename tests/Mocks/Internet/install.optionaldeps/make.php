...
$package4 = new \Pyrus\Package(false);
$xmlcontainer = new \Pyrus\PackageFile($p4);
$xml = new \Pyrus\Package\Xml(__DIR__ . '/package.xml', $package4, $xmlcontainer);
...
$package5 = new \Pyrus\Package(false);
$xmlcontainer = new \Pyrus\PackageFile($p5);
$xml = new \Pyrus\Package\Xml(__DIR__ . '/package.xml', $package5, $xmlcontainer);
...
$package6 = new \Pyrus\Package(false);
$xmlcontainer = new \Pyrus\PackageFile($p6);
$xml = new \Pyrus\Package\Xml(__DIR__ . '/package.xml', $package6, $xmlcontainer);
