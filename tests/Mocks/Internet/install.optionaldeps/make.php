...
$package6 = new PEAR2_Pyrus_Package(false);
$xmlcontainer = new PEAR2_Pyrus_PackageFile($p6);
$xml = new PEAR2_Pyrus_Package_Xml(__DIR__ . '/package.xml', $package6, $xmlcontainer);
