--TEST--
\Pyrus\Channel Create new channel
--FILE--
<?php
...
$test->assertIsa('\Pyrus\ChannelFile\v1\Servers', $channel->mirrors, 'Wrong mirrors class');
...
$test->assertIsa('\Pyrus\ChannelFile\v1\Mirror', $channel->mirrors['pear.mirror.com'], 'Mirror was set');
$test->assertIsa('\Pyrus\ChannelFile\v1\Mirror', $channel->mirrors['pear.mirror2.com'], 'Mirror #2 was set');
$test->assertIsa('\Pyrus\ChannelFile\v1\Mirror', $channel->mirrors['pear.mirror.com'], 'Mirror #1 still exists');
